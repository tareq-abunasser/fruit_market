...
import 'features/account/presentation/cubit/user_form/user_form_cubit.dart'
    as _i100;
import 'features/auth/data/datasources/auth_local_data_source.dart' as _i64;
...
import 'features/cart/domain/usecases/update_cart_item.dart' as _i55;
...
import 'features/category/presentation/cubit/category_cubit.dart' as _i93;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i68.FavouriteActorCubit>(
      () => _i68.FavouriteActorCubit(get<_i67.DeleteFavouriteItem>()));
  ...
  gh.factory<_i92.CartWatcherCubit>(
      () => _i92.CartWatcherCubit(get<_i69.GetCartItems>()));
  gh.factory<_i93.CategoryCubit>(
      () => _i93.CategoryCubit(get<_i70.GetCategories>()));
  gh.factory<_i94.FavouriteWatcherCubit>(
      () => _i94.FavouriteWatcherCubit(get<_i71.GetFavouriteItems>()));
  gh.lazySingleton<_i95.GetSignedInUser>(
